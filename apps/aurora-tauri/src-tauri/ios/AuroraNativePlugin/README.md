...
This Swift package is the iOS-side Tauri mobile plugin skeleton for IOS-002 through IOS-007. It exposes app-owned invocation evidence for App Intents, Shortcuts, share/deep-link entrypoints, widgets, file associations, and local-light inference provider discovery without claiming Siri replacement.
