...
private let auroraNodeConfigV2Key = "aurora.nodeConfig.v2"
...
enum AuroraThinPeerStorage {
  ...
  static func nodeConfigV2Get() -> [String: Any] {
    let value: Any = UserDefaults.standard.string(forKey: auroraNodeConfigV2Key) ?? NSNull()
    return [
      "key": auroraNodeConfigV2Key,
      "value": value,
      "platform": "ios",
      "backend": "ios-user-defaults",
      "persisted": true,
  ...
  static func nodeConfigV2Set(value: String) throws -> [String: Any] {
    guard value.utf8.count <= 65_536 else {
      throw AuroraThinStorageError.nodeConfigTooLarge
    }
    UserDefaults.standard.set(value, forKey: auroraNodeConfigV2Key)
    return [
      "key": auroraNodeConfigV2Key,
      "ok": true,
      "platform": "ios",
  ...
  static func nodeConfigV2Delete() -> [String: Any] {
    UserDefaults.standard.removeObject(forKey: auroraNodeConfigV2Key)
    return [
      "key": auroraNodeConfigV2Key,
      "ok": true,
      "platform": "ios",
