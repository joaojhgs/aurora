...
from app.database.models import CronJob as Job, ScheduleType, JobStatus
...
class TestSchedulerManager:
    ...
    async def test_create_cron_job(self, scheduler_manager, mock_db_manager):
        ...
        job_id = await scheduler_manager.create_cron_job(
            name=name,
    ...
    async def test_create_absolute_job(self, scheduler_manager, mock_db_manager):
        ...
        job_id = await scheduler_manager.create_absolute_job(
            name=name,
