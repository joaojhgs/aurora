// @ts-nocheck -- upstream registry source is kept verbatim for local adaptation; Aurora strict TS validates wrappers that consume it.
"use client";
...
const MermaidDiagramImpl: FC<MermaidDiagramProps> = ({
  ...
  if (result.error) {
    return (
      ...
      >
        <div className="overflow-x-auto p-4 text-sm whitespace-pre-wrap">
          {code.trim()}
        </div>
