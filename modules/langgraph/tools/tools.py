...
from modules.langgraph.tools.self_operating_computer import self_operating_computer_tool

# Export all tools to bind to LLM
tools = [search_brave_tool, upsert_memory_tool, openrecall_search_tool, current_screen_tool, self_operating_computer_tool]