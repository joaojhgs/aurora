...
### DBMethods (`db.py`)
`SAVE_MESSAGE`, `GET_MESSAGES`, `GET_MESSAGES_FOR_DATE`, `DELETE_MESSAGE`, `UPDATE_MESSAGE`, `RAG_SEARCH`, `RAG_STORE`, `RAG_DELETE`, `RAG_GET`, `RAG_LIST`, `RAG_LIST_NAMESPACES`, `RAG_SEARCH_REMOTE`, `RAG_GET_PROVENANCE`, `RAG_EXPORT_NAMESPACE`, `RAG_IMPORT_NAMESPACE`, `SAVE_CRON_JOB`, `GET_CRON_JOBS`, `DELETE_CRON_JOB`, `HEALTH_CHECK`, `CREATE_USER`, `GET_USER_BY_USERNAME`, `GET_USER_BY_ID`, `COUNT_USERS`, `LIST_USERS`, `UPDATE_USER`, `DELETE_USER`, `CREATE_DEVICE`, `GET_DEVICE_BY_ID`, `LIST_DEVICES`, `DELETE_DEVICE`, `CREATE_TOKEN`, `GET_TOKEN_BY_HASH`, `GET_TOKEN_BY_ID`, `LIST_TOKENS`, `UPDATE_TOKEN_SCOPES`, `REVOKE_TOKEN`, `GET_AUDIT_LOG`, `COUNT_AUDIT_EVENTS`, `SAVE_MESH_CREDENTIAL`, `GET_MESH_CREDENTIAL_BY_ROOM`, `DELETE_MESH_CREDENTIAL`, `EXECUTE_SQL`
