"""Entry point for running STTCoordinatorService as a standalone process."""
...
async def main():
    """Main entry point for STTCoordinatorService process."""
    service_name = "STTCoordinatorService"
