...
def openrecall_search_tool(
    ...
    This tool should be used whenever the LLM deems the user is asking for something related to what he did in the past,
    allowing the LLM to have a better understanding of the user's context
    The LLM should fill the content input with the user query adapted for a semantic search in the database

    Args:
        input: User query adapted for semantic search
