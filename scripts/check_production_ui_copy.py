...
FORBIDDEN_PATTERNS: tuple[tuple[str, re.Pattern[str]], ...] = (
    ...
    ("room-password", re.compile(r"\broom[-_ /]?password\b", re.I)),
    ("remote-console", re.compile(r"\bremote[-_ /]?console\b", re.I)),
    ("mesh-node", re.compile(r"\bmesh[-_ /]?node\b", re.I)),
    ("runtime-tier", re.compile(r"\bruntime[-_ /]?tier\b", re.I)),
    ("sdk", re.compile(r"\bsdk\b", re.I)),
    ("webview", re.compile(r"\bwebview\b", re.I)),
