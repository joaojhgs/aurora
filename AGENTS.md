...
This project is indexed by GitNexus as **aurora** (50181 symbols, 117937 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/aurora/context` | Codebase overview, check index freshness |
| `gitnexus://repo/aurora/clusters` | All functional areas |
| `gitnexus://repo/aurora/processes` | All execution flows |
| `gitnexus://repo/aurora/process/{name}` | Step-by-step execution trace |
