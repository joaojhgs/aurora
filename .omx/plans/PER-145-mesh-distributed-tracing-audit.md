...
Source context read:
- Multica issue description, labels, metadata, and empty comment history.
...
- Code paths: `app/messaging/mesh_bus.py`, `app/services/gateway/mesh/peer_bridge.py`, `app/services/gateway/webrtc/rpc.py`, `app/shared/services/base_service.py`, `app/services/auth/service.py`.
...
1. Add a small mesh tracing helper in the gateway mesh package for correlation ID generation/extraction, redaction, and audit detail construction.
...
- `uv run ruff check app/messaging/mesh_bus.py app/messaging/bus.py app/messaging/local_bus.py app/messaging/bullmq_bus.py app/services/gateway/mesh/tracing.py app/services/gateway/mesh/peer_bridge.py app/services/gateway/webrtc/rpc.py tests/unit/gateway/test_peer_bridge.py tests/unit/gateway/test_rpc.py tests/integration/test_mesh_routing.py`
- `git diff --check`
