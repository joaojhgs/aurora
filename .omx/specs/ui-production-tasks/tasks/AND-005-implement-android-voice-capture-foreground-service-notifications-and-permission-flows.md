# AND-005 — Implement Android voice capture, foreground service, notifications, and permission flows
...
PTT/background voice states map to OS permission and foreground constraints.
