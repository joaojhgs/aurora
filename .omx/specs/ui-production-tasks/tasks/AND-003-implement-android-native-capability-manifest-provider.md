# AND-003 — Implement Android native capability manifest provider
...
SDK receives mic/notification/biometric/local-network/assistant-role/foreground-service/file/share status.
