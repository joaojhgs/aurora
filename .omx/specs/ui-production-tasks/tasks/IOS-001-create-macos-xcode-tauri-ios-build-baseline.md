# IOS-001 — Create macOS/Xcode/Tauri iOS build baseline
...
- **Parallelizable with:** AND-001, UI-004
...
iOS app builds/runs on simulator/device in macOS CI/dev environment.
