# AND-007 — Implement Android secure storage and biometric admin unlock
...
Tokens/admin confirmations can use Android Keystore/Biometrics through SDK/Tauri plugin.
