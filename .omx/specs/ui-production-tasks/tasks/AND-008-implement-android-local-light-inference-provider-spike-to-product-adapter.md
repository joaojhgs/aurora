# AND-008 — Implement Android local-light inference provider spike-to-product adapter
...
Mobile runtime appears as a capability-gated provider, not a separate orchestrator fork.
