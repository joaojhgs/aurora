# AND-009 — Implement Android release, signing, Play/App Bundle, and device matrix gate
...
Android release path covers thin, mesh, assistant-role-capable, and fallback devices.
