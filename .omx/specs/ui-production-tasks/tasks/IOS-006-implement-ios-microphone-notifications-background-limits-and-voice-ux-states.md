# IOS-006 — Implement iOS microphone, notifications, background limits, and voice UX states
...
Voice UI accurately reflects iOS permission and background limitations.
