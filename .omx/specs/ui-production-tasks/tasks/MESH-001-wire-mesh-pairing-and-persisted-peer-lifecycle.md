# MESH-001 — Wire mesh pairing and persisted peer lifecycle
...
Admins can review pending peers, fingerprints, scopes, approve/deny/remove, and see persisted trust.
