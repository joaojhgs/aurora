# IOS-005 — Implement iOS Keychain/biometric secure storage and admin unlock
...
Tokens, mesh credentials and admin confirmation unlocks use Keychain/Face ID/Touch ID.
