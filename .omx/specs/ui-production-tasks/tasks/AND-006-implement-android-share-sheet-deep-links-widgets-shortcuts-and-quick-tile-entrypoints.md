# AND-006 — Implement Android share sheet, deep links, widgets/shortcuts, and quick tile entrypoints
...
Aurora can be invoked from Android system surfaces even when assistant role is unavailable.
