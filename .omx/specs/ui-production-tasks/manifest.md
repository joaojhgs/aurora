...
| SDK-006 | P1 | sdk | SDK-001, SDK-002, SDK-004, SDK-005, MESH-GAP-003, MESH-GAP-004, MESH-GAP-005 | `tasks/SDK-006-implement-capability-graph-engine.md` |
...
| SDK-012 | P1 | sdk | SDK-001, MESH-GAP-002, MESH-GAP-003, MESH-GAP-005 | `tasks/SDK-012-implement-route-privacy-policy-engine.md` |
| SDK-013 | P1 | sdk | SDK-001, SDK-003, BE-004, MESH-GAP-005 | `tasks/SDK-013-implement-adminaction-client-controller.md` |
...
| BE-011 | P2 | backend/tools | P0-002, MESH-GAP-005 | `tasks/BE-011-add-tool-risk-taxonomy-and-approval-hints.md` |
| BE-012 | P2 | backend/auth-mesh | BE-003 | `tasks/BE-012-add-pending-pairing-queue-list-event-contract.md` |
| BE-013 | P2 | backend/mesh | BE-002, MESH-GAP-003 | `tasks/BE-013-add-peer-capability-manifest-and-mesh-route-explain-contracts.md` |
...
| BE-017 | P2 | backend/db-rag | P0-002, BE-004, MESH-GAP-007 | `tasks/BE-017-add-memory-rag-provenance-export-delete-contracts.md` |
| BE-018 | P2 | backend/scheduler | P0-002, BE-004, MESH-GAP-009 | `tasks/BE-018-add-scheduler-management-exposure-and-adminaction-contract.md` |
...
| UIA-003 | P7 | assistant-tools | UIA-001, SDK-013, BE-011, MESH-GAP-004, MESH-GAP-005, MESH-GAP-006 | `tasks/UIA-003-wire-tool-approval-cards-and-tool-result-display.md` |
| UIA-004 | P7 | assistant-voice | UIA-001, UI-004, SDK-006, MESH-GAP-008 | `tasks/UIA-004-wire-voice-ptt-wake-transcription-and-tts-playback-per-mode.md` |
| UIA-005 | P7 | assistant-context | UIA-001, BE-008, SDK-006 | `tasks/UIA-005-wire-attachments-and-mobile-share-intake-ui.md` |
| UIA-006 | P7 | assistant-memory | UIA-001, SDK-007, BE-017, MESH-GAP-007 | `tasks/UIA-006-wire-conversation-history-memory-and-rag-provenance-ui.md` |
...
| ADM-007 | P8 | admin | SDK-007, BE-011, MESH-GAP-004, MESH-GAP-005 | `tasks/ADM-007-wire-plugins-mcp-tools-and-reload-install-states.md` |
| ADM-008 | P8 | admin | SDK-007, BE-004, MESH-GAP-010 | `tasks/ADM-008-wire-audit-log-details-and-export.md` |
| ADM-009 | P8 | admin | SDK-013, BE-005, MESH-GAP-010 | `tasks/ADM-009-wire-diagnostics-probes-and-redacted-support-bundle.md` |
...
| ADM-012 | P8 | admin | SDK-007, SDK-013, BE-018, MESH-GAP-009 | `tasks/ADM-012-wire-scheduler-jobs-and-automation-management.md` |
...
| MESH-003 | P9 | mesh | MESH-001, BE-013, SDK-012, MESH-GAP-002, MESH-GAP-003 | `tasks/MESH-003-wire-route-policy-editor-and-route-explain-ui.md` |
...
| QA-002 | P10 | qa-release | UIA-001, ADM-001, TAURI-004, AND-001, IOS-001, MESH-GAP-011 | `tasks/QA-002-build-multi-mode-e2e-matrix.md` |
| QA-003 | P10 | qa-release | BE-004, SDK-012, ADM-008, MESH-GAP-005, MESH-GAP-011 | `tasks/QA-003-build-security-privacy-regression-suite.md` |
...
| QA-008 | P10 | qa-release | QA-002, BE-016, SDK-014, MESH-004, MESH-GAP-011 | `tasks/QA-008-build-thread-process-mesh-transport-parity-gate.md` |
