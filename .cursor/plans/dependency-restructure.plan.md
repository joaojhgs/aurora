...
**Goal**: Set up tools to analyze actual dependency usage**Tasks**:
...
**Goal**: Identify exact dependencies each service needs**Tasks**:
...
**Goal**: Identify dependencies needed only in specific contexts**Tasks**:
...
**Goal**: Find dependencies that can be removed**Tasks**:
...
**Goal**: Design new dependency management structure**Proposed Structure**:**Primary**: Use `pyproject.toml` for all dependency management
...
**Goal**: Update Dockerfiles to use service-specific dependencies**Tasks**:
...
**Goal**: Create tools for easy dependency installation**Tasks**:
...
**Goal**: Document new structure and migration path**Tasks**:
